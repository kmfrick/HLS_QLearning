...
// ==============================================================
#ifndef __learn_mul_mul_15nhbi__HH__
#define __learn_mul_mul_15nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_mul_mul_15nhbi) {
    ...
    SC_CTOR(learn_mul_mul_15nhbi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
