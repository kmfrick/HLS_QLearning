...
// ==============================================================
#ifndef __learn_fpext_32ns_lbW__HH__
#define __learn_fpext_32ns_lbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_fpext_32ns_lbW) {
    ...
    SC_CTOR(learn_fpext_32ns_lbW):  ACMP_fpext_U ("ACMP_fpext_U") {
