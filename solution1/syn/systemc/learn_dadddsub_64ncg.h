...
// ==============================================================
#ifndef __learn_dadddsub_64ncg__HH__
#define __learn_dadddsub_64ncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_dadddsub_64ncg) {
    ...
    SC_CTOR(learn_dadddsub_64ncg):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
