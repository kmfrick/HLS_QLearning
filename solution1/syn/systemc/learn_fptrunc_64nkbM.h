...
// ==============================================================
#ifndef __learn_fptrunc_64nkbM__HH__
#define __learn_fptrunc_64nkbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_fptrunc_64nkbM) {
    ...
    SC_CTOR(learn_fptrunc_64nkbM):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
