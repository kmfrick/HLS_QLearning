...
// ==============================================================
#ifndef __learn_mul_mul_15ng8j__HH__
#define __learn_mul_mul_15ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_mul_mul_15ng8j) {
    ...
    SC_CTOR(learn_mul_mul_15ng8j):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
