...
// ==============================================================
#ifndef __learn_dcmp_64ns_6rcU__HH__
#define __learn_dcmp_64ns_6rcU__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_dcmp_64ns_6rcU) {
    ...
    SC_CTOR(learn_dcmp_64ns_6rcU):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
