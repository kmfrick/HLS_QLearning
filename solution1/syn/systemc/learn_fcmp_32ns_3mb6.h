...
// ==============================================================
#ifndef __learn_fcmp_32ns_3mb6__HH__
#define __learn_fcmp_32ns_3mb6__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(learn_fcmp_32ns_3mb6) {
    ...
    SC_CTOR(learn_fcmp_32ns_3mb6):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
