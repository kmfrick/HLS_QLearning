...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.learn.autotvin_w.dat"
         "c.learn.autotvin_box.dat"
         "c.learn.autotvin_e.dat"
         "c.learn.autotvin_xbar.dat"
         "c.learn.autotvin_v.dat"
         "c.learn.autotvin_x.dat"
         "c.learn.autotvin_x_dot.dat"
         "c.learn.autotvin_theta.dat"
         "c.learn.autotvin_theta_dot.dat"
         "c.learn.autotvout_w.dat"
         "c.learn.autotvout_e.dat"
         "c.learn.autotvout_xbar.dat"
         "c.learn.autotvout_v.dat"
         "c.learn.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.learn.autotvout_w.dat"
         "rtl.learn.autotvout_e.dat"
         "rtl.learn.autotvout_xbar.dat"
         "rtl.learn.autotvout_v.dat"
         "rtl.learn.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
